...
from main_app.mixins import MovieMixin
...
class Actor(BasePerson, MovieMixin):
    pass

class Movie(MovieMixin):
    ...
    starring_actor = models.ForeignKey(to=Actor, on_delete=models.SET_NULL, blank=True,
                                       null=True, related_name='starring_movies')
